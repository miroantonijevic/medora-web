...
export async function seedAmenities({ payload }: { payload: Payload }) {
  ...
  if (!hasAmenities) {
    const amenitiesItem = {
      ...
      href: '/amenities',
      children: [
        { label: 'Wellness', href: '/amenities/wellness' },
        { label: 'Dining & Bars', href: '/amenities/dining-bars' },
      ...
      data: {
        items: [
          ...existing,
          {
            ...
            children: [
              { label: 'Wellness', href: '/amenities/wellness' },
              { label: 'Hrana i piće', href: '/amenities/dining-bars' },
      ...
      data: {
        items: [
          ...existing,
          {
            ...
            children: [
              { label: 'Wellness', href: '/amenities/wellness' },
              { label: 'Essen & Bars', href: '/amenities/dining-bars' },
