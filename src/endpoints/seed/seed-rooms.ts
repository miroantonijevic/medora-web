...
const AURI_ROOMS = [
  {
    ...
    imageFiles: [
      {
        name: 'auri-superior-double-sea.jpg',
        rel: 'rooms/auri-superior-double-sea.jpg',
        mime: 'image/jpeg',
      },
    ...
    hr: {
      ...
      description:
        'Ova soba ima veliki balkon na kojem \u0107ete prona\u0107i udobne le\u017ealjke na kojima mo\u017eete u\u017eivati u sun\u010danju pod zlatnim suncem dok se osvje\u017eavaju umiruju\u0107im ljetnim povjetarcem koji dolazi s mora. Idealno za obitelji s jednim djetetom, parove ili mlade koji putuju zajedno. Ova soba ima jedan ve\u0107i i jedan manji balkon s pogledom na more, Biokovo i Podgoru.',
      inclusions: [
        'Besplatni Wi-Fi',
    ...
    de: {
      ...
      description:
        'Dieses Zimmer verf\u00fcgt \u00fcber einen gro\u00dfen Balkon mit bequemen Sonnenliegen, auf denen Sie unter der warmen Sonne relaxen k\u00f6nnen, w\u00e4hrend Sie von einer sanften Meeresbrise erfrischt werden. Ideal f\u00fcr Familien mit einem Kind, Paare oder junge Reisende. Das Zimmer bietet von einem gr\u00f6\u00dferen und einem kleineren Balkon aus einen herrlichen Blick auf das Meer, den Biokovo und Podgora.',
      inclusions: [
        'Kostenloses WLAN',
  ...
  },
  {
    ...
    imageFiles: [
      {
        name: 'auri-family-superior-actual.jpg',
        rel: 'rooms/auri-family-superior-actual.jpg',
        mime: 'image/jpeg',
      },
    ...
    de: {
      ...
      description:
        'Superior Familienzimmer mit Balkon und Meerblick verf\u00fcgen \u00fcber zwei Schlafzimmer und ein ger\u00e4umiges Badezimmer. Ein Schlafzimmer hat ein Doppelbett, das andere Standardeinzelbetten. Am Abend beim Sonnenuntergang k\u00f6nnen Sie vom Balkon die Sch\u00f6nheit der Natur Podgoras genie\u00dfen \u2014 ein unvergesslicher Sonnenuntergang mit Ihren Liebsten.',
      inclusions: [
        'Kostenloses WLAN',
  ...
  },
  {
    ...
    imageFiles: [
      {
        name: 'auri-deluxe-suite-actual.jpg',
        rel: 'rooms/auri-deluxe-suite-actual.jpg',
        mime: 'image/jpeg',
      },
    ...
    en: {
      ...
      description:
        'The Deluxe apartment is located on the top floor of Hotel Medora Auri and features a 15 m\u00b2 terrace with a stunning view of the Adriatic Sea and the Dalmatian islands. The spacious apartment has two bedrooms, a living room, dining area and a large bathroom with bathtub. Complete your experience in this beautiful apartment by surrendering to the restorative power of unforgettable sunsets from the large terrace sun loungers.',
      inclusions: [
        'Free Wi-Fi',
        '2x balcony with outdoor furniture',
        'Air conditioning / heating',
  ...
  // ─── Additional double rooms (sea-view sub-group) ──────────────────────────
  {
    ...
    imageFiles: [
      {
        name: 'auri-comfort-double-sea.jpg',
        rel: 'rooms/auri-comfort-double-sea.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
      ...
      description:
        'Comfort double room with balcony overlooking the Adriatic Sea. Ideal for couples or solo travellers seeking the perfect seaside retreat on the Makarska Riviera.',
      inclusions: [
        'Free Wi-Fi',
        'Balcony with outdoor furniture',
        'Air conditioning / heating',
        'Bathroom with shower, hairdryer & complimentary toiletries',
        'Wardrobe',
        'Safe',
        'Flat-screen TV with satellite channels',
        'Minibar',
        'Kettle with coffee & tea sachets',
        'Work desk',
        'Telephone',
        'Radio',
        'Wake-up service',
    ...
    hr: {
      ...
      description:
        'Comfort dvokrevetna soba s balkonom s pogledom na Jadransko more. Idealna za parove ili solo putnike koji tra\u017ee savr\u0161en odmor uz more na Makarskoj rivijeri.',
      inclusions: [
        'Besplatni Wi-Fi',
        'Balkon s vanjskim namje\u0161tajem',
        'Klima ure\u0111aj/grijanje',
        'Kupaonica s tu\u0161em, su\u0161ilom za kosu i toaletnim priborom',
        'Garderoba/ormar',
        'Sef',
        'TV ravnog ekrana sa satelitskim kanalima',
        'Minibar',
        'Kuhalo za vodu s kavom i \u010dajem',
        'Radni stol',
        'Telefon',
        'Radio',
        'Usluga bu\u0111enja',
    ...
    de: {
      ...
      description:
        'Comfort Doppelzimmer mit Balkon und Blick auf die Adria. Ideal f\u00fcr Paare oder Alleinreisende an der Makarska Riviera.',
      inclusions: [
        'Kostenloses WLAN',
        'Balkon mit Au\u00dfenm\u00f6beln',
        'Klimaanlage / Heizung',
        'Badezimmer mit Dusche, Haartrockner & Toilettenartikeln',
        'Kleiderschrank',
        'Safe',
        'Flachbild-TV mit Satellitenkan\u00e4len',
        'Minibar',
  ...
  // ─── Additional double rooms (creative sub-group) ──────────────────────────
  {
    ...
    imageFiles: [
      {
        name: 'auri-comfort-double-park-sea.jpg',
        rel: 'rooms/auri-comfort-double-park-sea.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
      ...
      description:
        'Comfort double room with balcony offering views of the Biokovo nature park and the Adriatic. Ideal for guests who love nature and tranquillity combined with sea views.',
      inclusions: [
        'Free Wi-Fi',
        'Balcony with outdoor furniture',
        'Air conditioning / heating',
    ...
    hr: {
      ...
      description:
        'Comfort dvokrevetna soba s balkonom s pogledom na park prirode Biokovo i Jadransko more. Idealna za goste koji vole prirodu i mir uz pogled na more.',
      inclusions: [
        'Besplatni Wi-Fi',
        'Balkon s vanjskim namje\u0161tajem',
        'Klima ure\u0111aj/grijanje',
    ...
    de: {
      ...
      description:
        'Comfort Doppelzimmer mit Balkon und Blick auf den Biokovo-Naturpark und die Adria. Ideal f\u00fcr G\u00e4ste, die Natur und Ruhe mit Meerblick verbinden m\u00f6chten.',
      inclusions: [
        'Kostenloses WLAN',
        'Balkon mit Au\u00dfenm\u00f6beln',
        'Klimaanlage / Heizung',
  ...
  },
  {
    ...
    en: {
      ...
      description:
        'Comfort double room with views of the Biokovo nature park. A peaceful retreat for guests who prefer lush greenery and natural surroundings.',
      inclusions: [
        'Free Wi-Fi',
        'Balcony with outdoor furniture',
        'Air conditioning / heating',
    ...
    hr: {
      ...
      description:
        'Comfort dvokrevetna soba s pogledom na park prirode Biokovo. Mirno utoci\u0161te za goste koji preferiraju zelenilo i prirodno okru\u017eenje.',
      inclusions: [
        'Besplatni Wi-Fi',
        'Balkon s vanjskim namje\u0161tajem',
        'Klima ure\u0111aj/grijanje',
    ...
    de: {
      ...
      description:
        'Comfort Doppelzimmer mit Blick auf den Biokovo-Naturpark. Ein ruhiger R\u00fcckzugsort f\u00fcr G\u00e4ste, die gr\u00fcne Natur bevorzugen.',
      inclusions: [
        'Kostenloses WLAN',
        'Balkon mit Au\u00dfenm\u00f6beln',
        'Klimaanlage / Heizung',
  ...
  },
  {
    ...
    imageFiles: [
      {
        name: 'auri-comfort-double-pines.jpg',
        rel: 'rooms/auri-comfort-double-pines.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
      ...
      description:
        'Cosy comfort room in the Residences building with balcony views of ancient pine trees and a glimpse of the sea. A calm, shaded setting for a relaxing holiday.',
      inclusions: [
        'Free Wi-Fi',
        'Balcony with outdoor furniture',
        'Air conditioning / heating',
    ...
    hr: {
      ...
      description:
        'Udobna soba u Rezidencijama s balkonom s pogledom na stoljetne borove i djelimi\u010dnim pogledom na more. Mirno i zasjen\u010deno okru\u017eenje za opu\u0161taju\u0107i odmor.',
      inclusions: [
        'Besplatni Wi-Fi',
        'Balkon s vanjskim namje\u0161tajem',
        'Klima ure\u0111aj/grijanje',
    ...
    de: {
      ...
      description:
        'Gem\u00fctliches Comfort-Zimmer in den Residenzen mit Balkon und Blick auf uralte Kiefern und einem Hauch Meer. Eine ruhige, schattige Umgebung f\u00fcr einen entspannenden Urlaub.',
      inclusions: [
        'Kostenloses WLAN',
        'Balkon mit Au\u00dfenm\u00f6beln',
        'Klimaanlage / Heizung',
  ...
  },
  {
    ...
    imageFiles: [
      {
        name: 'auri-double-garden-res.jpg',
        rel: 'rooms/auri-double-garden-res.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
      ...
      description:
        'Double room in the Residences with views of the beautiful garden. A quiet, comfortable choice for guests who prefer a green, shaded setting for their holiday.',
      inclusions: [
        'Free Wi-Fi',
        'Balcony with outdoor furniture',
        'Air conditioning / heating',
    ...
    hr: {
      ...
      description:
        'Dvokrevetna soba u Rezidencijama s pogledom na prekrasan vrt. Tihi i udoban izbor za goste koji preferiraju zeleno, zasjen\u010deno okru\u017eenje.',
      inclusions: [
        'Besplatni Wi-Fi',
        'Balkon s vanjskim namje\u0161tajem',
        'Klima ure\u0111aj/grijanje',
    ...
    de: {
      ...
      description:
        'Doppelzimmer in den Residenzen mit Blick auf den sch\u00f6nen Garten. Eine ruhige, komfortable Wahl f\u00fcr G\u00e4ste, die eine gr\u00fcne Umgebung bevorzugen.',
      inclusions: [
        'Kostenloses WLAN',
        'Balkon mit Au\u00dfenm\u00f6beln',
        'Klimaanlage / Heizung',
  ...
  // ─── Additional family rooms ────────────────────────────────────────────────
  {
    ...
    imageFiles: [
      {
        name: 'auri-family-garden-res.jpg',
        rel: 'rooms/auri-family-garden-res.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
      ...
      description:
        'Spacious family room in the Residences with balcony overlooking the garden and sea. Two bedrooms and a bathroom provide the privacy and space that families need.',
      inclusions: [
        'Free Wi-Fi',
        '2x balcony with outdoor furniture',
        'Air conditioning / heating',
        'Bathroom with bathtub, hairdryer & complimentary toiletries + extra WC',
        '2x wardrobe',
        'Safe',
        '2x flat-screen TV with satellite channels',
        'Minibar',
    ...
    hr: {
      ...
      description:
        'Prostrana obiteljska soba u Rezidencijama s balkonom s pogledom na vrt i more. Dvije spava\u0107e sobe i kupaonica pru\u017eaju privatnost i prostor koji obitelji trebaju.',
      inclusions: [
        'Besplatni Wi-Fi',
        '2x balkon s vanjskim namje\u0161tajem',
        'Klima ure\u0111aj/grijanje',
        'Kupaonica s kadom, su\u0161ilom za kosu i toaletnim priborom + dodatni WC',
        '2x garderoba/ormar',
        'Sef',
        '2x TV ravnog ekrana sa satelitskim kanalima',
        'Minibar',
    ...
    de: {
      ...
      description:
        'Ger\u00e4umiges Familienzimmer in den Residenzen mit Balkon und Blick auf Garten und Meer. Zwei Schlafzimmer und ein Badezimmer bieten die Privatsph\u00e4re, die Familien brauchen.',
      inclusions: [
        'Kostenloses WLAN',
        '2x Balkon mit Au\u00dfenm\u00f6beln',
        'Klimaanlage / Heizung',
        'Badezimmer mit Badewanne, Haartrockner & Toilettenartikeln + extra WC',
        '2x Kleiderschrank',
        'Safe',
        '2x Flachbild-TV mit Satellitenkan\u00e4len',
        'Minibar',
  ...
  },
  {
    ...
    en: {
      ...
      description:
        'Compact family room in the Residences, designed for young families seeking comfort at a great value. One double bed and two pull-out beds make it ideal for families with small children.',
      inclusions: [
        'Free Wi-Fi',
        'Balcony with outdoor furniture',
        'Air conditioning / heating',
    ...
    hr: {
      ...
      description:
        'Kompaktna obiteljska soba u Rezidencijama za mlade obitelji koje \u017eele udobnost uz razumnu cijenu. Bra\u010dni krevet i dva kreveta na izvla\u010denje, idealna za obitelji s malom djecom.',
      inclusions: [
        'Besplatni Wi-Fi',
        'Balkon s vanjskim namje\u0161tajem',
        'Klima ure\u0111aj/grijanje',
    ...
    de: {
      ...
      description:
        'Kompaktes Familienzimmer in den Residenzen f\u00fcr junge Familien, die Komfort zu einem guten Preis-Leistungs-Verh\u00e4ltnis suchen. Doppelbett und zwei Ausziehbetten, ideal f\u00fcr Familien mit kleinen Kindern.',
      inclusions: [
        'Kostenloses WLAN',
        'Balkon mit Au\u00dfenm\u00f6beln',
        'Klimaanlage / Heizung',
...
const ORBIS_ROOMS = [
  {
    ...
    imageFiles: [
      {
        name: 'orbis-deluxe-2bed-actual.jpg',
        rel: 'rooms/orbis-deluxe-2bed-actual.jpg',
        mime: 'image/jpeg',
      },
      { name: 'orbis-deluxe-pool.jpg', rel: 'rooms/orbis-deluxe-pool.jpg', mime: 'image/jpeg' },
      {
        name: 'orbis-deluxe-outside.jpg',
        rel: 'rooms/orbis-deluxe-outside.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
  ...
  },
  {
    ...
    imageFiles: [
      {
        name: 'orbis-premium-2bed-actual.jpg',
        rel: 'rooms/orbis-premium-2bed-actual.jpg',
        mime: 'image/jpeg',
      },
      {
        name: 'orbis-premium-terrace.jpg',
        rel: 'rooms/orbis-premium-terrace.jpg',
        mime: 'image/jpeg',
      },
      {
        name: 'orbis-premium-inside.jpg',
        rel: 'rooms/orbis-premium-inside.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
    ...
    de: {
      ...
      description:
        'Das Haus verf\u00fcgt \u00fcber zwei voll ausgestattete Schlafzimmer \u2014 eines mit Doppelbett und eines mit zwei Einzelbetten \u2014 sowie zwei Badezimmer mit Dusche, WC und Toilettenartikeln und eine K\u00fcche mit K\u00fchlschrank, Mikrowelle und Filterkaffeemaschine. Entspannen Sie auf der ger\u00e4umigen Sonnenterrasse und genie\u00dfen Sie den privaten beheizten Pool. Klimaanlage, TV und kostenloses WLAN sorgen f\u00fcr unbeschwerten Genuss jedes Moments in Podgora.',
      inclusions: [
  ...
  },
  {
    ...
    imageFiles: [
      {
        name: 'orbis-superior-2bed-actual.png',
        rel: 'rooms/orbis-superior-2bed-actual.png',
        mime: 'image/png',
      },
      {
        name: 'orbis-superior-terrace1.jpg',
        rel: 'rooms/orbis-superior-terrace1.jpg',
        mime: 'image/jpeg',
      },
      {
        name: 'orbis-superior-terrace2.jpg',
        rel: 'rooms/orbis-superior-terrace2.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
  ...
  // ─── Superior disabled (small group) ──────────────────────────────────────
  {
    ...
    en: {
      ...
      description:
        'Superior mobile home specially adapted for guests with disabilities. Features wider doorways, an accessible bathroom and all standard amenities to ensure a comfortable stay.',
      inclusions: [
        'Free Wi-Fi',
        'Air conditioning',
        'Covered terrace with seating for 4',
        '2 bathrooms with shower & WC (wheelchair accessible)',
        'Bedroom with double bed (160\u00d7200)',
        'Bedroom with two single beds (80\u00d7200)',
        'Extra bed (135\u00d7185 cm)',
        'Kitchen with 4 electric hobs & fridge-freezer',
    ...
    hr: {
      ...
      description:
        'Superior mobilna ku\u0107ica posebno prilagodena za osobe s invaliditetom. \u0160ira vrata, pristupa\u010dna kupaonica i svi standardni sadr\u017eaji za ugodan boravak. Dvije spava\u0107e sobe i prostrani dnevni boravak.',
      inclusions: [
        'Besplatan Wi-Fi',
        'Klima ure\u0111aj',
        'Natkrivena terasa sa sje\u0111e\u0107om garniturom za 4 osobe',
        '2 kupaonice s tu\u0161-kabinom i WC-om (prilagodene osobama s invaliditetom)',
        'Soba s bra\u010dnim krevetom (160\u00d7200)',
        'Soba s dva odvojena kreveta (80\u00d7200)',
        'Dodatni le\u017eaj (135\u00d7185 cm)',
        'Kuhinja s 4 plo\u010de za kuhanje na struju, hladnjak s zamrziva\u010dem',
    ...
    de: {
      ...
      description:
        'Superior Mobilheim, speziell f\u00fcr G\u00e4ste mit Behinderungen angepasst. Breitere T\u00fcren, barrierefreies Badezimmer und alle Standardausstattungen f\u00fcr einen komfortablen Aufenthalt.',
      inclusions: [
        'Kostenloses WLAN',
        'Klimaanlage',
        '\u00dcberdachte Terrasse mit Sitzgelegenheiten f\u00fcr 4',
        '2 Badezimmer mit Dusche & WC (rollstuhlgerecht)',
        'Schlafzimmer mit Doppelbett (160\u00d7200)',
        'Schlafzimmer mit zwei Einzelbetten (80\u00d7200)',
        'Zusatzbett (135\u00d7185 cm)',
        'K\u00fcche mit 4 Elektrokochplatten & K\u00fchl-Gefrier-Kombination',
  ...
  // ─── Premium 1-bedroom (small group) ──────────────────────────────────────
  {
    ...
    imageFiles: [
      {
        name: 'orbis-premium-1bed-actual.jpg',
        rel: 'rooms/orbis-premium-1bed-actual.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
      ...
      description:
        'Premium mobile home with one bedroom and a private heated pool. Perfect for couples who want all the luxury of a private pool experience.',
      inclusions: [
        'Private heated pool with sun deck',
        'Free Wi-Fi',
        'Air conditioning',
        ...
        'Bedroom with double bed (160\u00d7200)',
        'Extra bed (135\u00d7185 cm)',
        'Kitchen with electric hobs & fridge-freezer',
        'Kitchenware & microwave',
        'Kettle with coffee & tea sachets',
        'Satellite TV',
        'Table & seating',
    ...
    hr: {
      ...
      description:
        'Premium mobilna ku\u0107ica s jednom spava\u0107om sobom i privatnim grijanim bazenom. Savr\u0161ena za parove koji \u017eele sve prednosti privatnog bazena.',
      inclusions: [
        'Privatni grijani bazen sa sun\u010dali\u0161tem',
        'Besplatan Wi-Fi',
        'Klima ure\u0111aj',
        'Natkrivena terasa sa sje\u0111e\u0107om garniturom',
        '1 kupaonica s tu\u0161-kabinom i WC-om',
        'Soba s bra\u010dnim krevetom (160\u00d7200)',
        'Dodatni le\u017eaj (135\u00d7185 cm)',
        'Kuhinja s plo\u010dama za kuhanje, hladnjak s zamrziva\u010dem',
        'Posu\u0111e, mikrovalna pe\u0107nica',
        'Kuhalo za vodu s kavom i \u010dajem',
        'TV sa satelitskim kanalima',
        'Stol i sje\u0111e\u0107a mjesta',
        'Sef',
        'Posteljina i ru\u010dnici uklju\u010deni u cijenu',
      ],
    },
    de: {
      ...
      description:
        'Premium Mobilheim mit einem Schlafzimmer und einem privaten beheizten Pool. Perfekt f\u00fcr Paare, die den Luxus eines privaten Pools genie\u00dfen m\u00f6chten.',
      inclusions: [
        'Privater beheizter Pool mit Sonnendeck',
        'Kostenloses WLAN',
        'Klimaanlage',
        '\u00dcberdachte Terrasse mit Sitzgelegenheiten',
        '1 Badezimmer mit Dusche & WC',
        'Schlafzimmer mit Doppelbett (160\u00d7200)',
        'Zusatzbett (135\u00d7185 cm)',
        'K\u00fcche mit Elektrokochplatten & K\u00fchl-Gefrier-Kombination',
        'Kochgeschirr & Mikrowelle',
        'Wasserkocher mit Kaffee- & Teebeuteln',
        'Satelliten-TV',
        'Tisch & Sitzpl\u00e4tze',
  ...
  // ─── Large cabins (6-7 persons) ────────────────────────────────────────────
  {
    ...
    imageFiles: [
      {
        name: 'orbis-deluxe-3bed-actual.jpg',
        rel: 'rooms/orbis-deluxe-3bed-actual.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
      ...
      description:
        'Spacious deluxe mobile home for larger families. Three bedrooms, two bathrooms, a private heated pool and fully equipped kitchen for a memorable holiday in Dalmatia.',
      inclusions: [
        'Private heated pool with sun deck & loungers',
        'Free Wi-Fi',
        'Air conditioning',
        'Covered terrace with seating for 6',
        '2 bathrooms with shower & WC',
        'Master bedroom with double bed',
        '2x bedroom with single beds',
        'Extra bed',
        'Kitchen with 4 electric hobs & fridge-freezer',
        'Kitchenware & microwave',
        'Kettle with coffee & tea sachets',
    ...
    hr: {
      ...
      description:
        'Prostrana deluxe mobilna ku\u0107ica za ve\u0107e obitelji. Tri spava\u0107e sobe, dvije kupaonice, privatni grijani bazen i opremljena kuhinja za nezaboravan odmor u Dalmaciji.',
      inclusions: [
        'Privatan grijani bazen sa sun\u010dali\u0161tem i le\u017ealjkama',
        'Besplatan Wi-Fi',
        'Klima ure\u0111aj',
        'Natkrivena terasa sa sje\u0111e\u0107om garniturom za 6 osoba',
        '2 kupaonice s tu\u0161-kabinom i WC-om',
        'Soba s bra\u010dnim krevetom',
        '2x soba s odvojenim krevetima',
        'Dodatni le\u017eaj',
        'Kuhinja s 4 plo\u010de za kuhanje, hladnjak s zamrziva\u010dem',
        'Posu\u0111e, mikrovalna pe\u0107nica',
        'Kuhalo za vodu s kavom i \u010dajem',
        'TV sa satelitskim kanalima',
        'Stol i sje\u0111e\u0107a mjesta za 6 osoba',
        'Sef',
        'Posteljina i ru\u010dnici uklju\u010deni u cijenu',
      ],
    },
    de: {
      ...
      description:
        'Ger\u00e4umiges Deluxe-Mobilheim f\u00fcr gr\u00f6\u00dfere Familien. Drei Schlafzimmer, zwei Badezimmer, privater beheizter Pool und voll ausgestattete K\u00fcche f\u00fcr einen unvergesslichen Urlaub in Dalmatien.',
      inclusions: [
        'Privater beheizter Pool mit Sonnendeck & Liegen',
        'Kostenloses WLAN',
        'Klimaanlage',
        '\u00dcberdachte Terrasse mit Sitzgelegenheiten f\u00fcr 6',
        '2 Badezimmer mit Dusche & WC',
        'Hauptschlafzimmer mit Doppelbett',
        '2x Schlafzimmer mit Einzelbetten',
        'Zusatzbett',
        'K\u00fcche mit 4 Elektrokochplatten & K\u00fchl-Gefrier-Kombination',
        'Kochgeschirr & Mikrowelle',
        'Wasserkocher mit Kaffee- & Teebeuteln',
        'Satelliten-TV',
        'Tisch & Sitzpl\u00e4tze f\u00fcr 6',
        'Safe',
        'Bettw\u00e4sche & Handtücher inklusive',
      ],
    },
  },
  {
    ...
    imageFiles: [
      {
        name: 'orbis-premium-3bed-actual.jpg',
        rel: 'rooms/orbis-premium-3bed-actual.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
      ...
      description:
        'Premium mobile home for larger groups with three bedrooms, private heated pool and two bathrooms. High comfort standard with modern furnishings and fully equipped kitchen.',
      inclusions: [
        'Private heated pool with sun deck',
        'Free Wi-Fi',
        'Air conditioning',
    ...
    hr: {
      ...
      description:
        'Premium mobilna ku\u0107ica za ve\u0107e grupe s tri spava\u0107e sobe, privatnim grijanim bazenom i dvije kupaonice. Visoki standard udobnosti s modernim namje\u0161tajem i opremljenom kuhinjom.',
      inclusions: [
        'Privatni grijani bazen sa sun\u010dali\u0161tem',
        'Besplatan Wi-Fi',
        'Klima ure\u0111aj',
    ...
    de: {
      ...
      description:
        'Premium Mobilheim f\u00fcr gr\u00f6\u00dfere Gruppen mit drei Schlafzimmern, privatem Pool und zwei Badezimmern. Hoher Komfortstandard mit modernem Mobiliar und voll ausgestatteter K\u00fcche.',
      inclusions: [
        'Privater beheizter Pool mit Sonnendeck',
        'Kostenloses WLAN',
        'Klimaanlage',
  ...
  },
  {
    ...
    imageFiles: [
      {
        name: 'orbis-superior-3bed-actual.jpg',
        rel: 'rooms/orbis-superior-3bed-actual.jpg',
        mime: 'image/jpeg',
      },
    ],
    en: {
      ...
      description:
        'Superior mobile home with three bedrooms and two bathrooms for larger groups. Spacious terrace, fully equipped kitchen and modern amenities for a comfortable Dalmatian holiday.',
      inclusions: [
        'Free Wi-Fi',
        'Air conditioning',
        'Covered terrace with seating for 6',
    ...
    hr: {
      ...
      description:
        'Superior mobilna ku\u0107ica s tri spava\u0107e sobe i dvije kupaonice za ve\u0107e grupe. Prostrana terasa, opremljena kuhinja i moderni sadr\u017eaji za ugodan dalmatinski odmor.',
      inclusions: [
        'Besplatan Wi-Fi',
        'Klima ure\u0111aj',
        'Natkrivena terasa sa sje\u0111e\u0107om garniturom za 6 osoba',
    ...
    de: {
      ...
      description:
        'Superior Mobilheim mit drei Schlafzimmern und zwei Badezimmern f\u00fcr gr\u00f6\u00dfere Gruppen. Ger\u00e4umige Terrasse, voll ausgestattete K\u00fcche und moderne Annehmlichkeiten.',
      inclusions: [
        'Kostenloses WLAN',
        'Klimaanlage',
        '\u00dcberdachte Terrasse mit Sitzgelegenheiten f\u00fcr 6',
  ...
  // ─── Pitch (pitches group) ─────────────────────────────────────────────────
  {
    ...
    en: {
      ...
      description:
        'Superior pitch of over 60 m\u00b2 at Medora Orbis Luxury Camp. Enjoy all camp amenities \u2014 pools, beach access, restaurant \u2014 while having your own spacious plot.',
      inclusions: [
        'Free Wi-Fi on the plot',
        'Access to shared sanitary facilities',
        'Electricity connection (16A)',
        'Water connection on the plot',
    ...
    hr: {
      ...
      description:
        'Superior parcela veli\u010dine vi\u0161e od 60 m\u00b2 u Medora Orbis Luxury Kampu. U\u017eivajte u svim sadr\u017eajima kampa \u2014 bazenima, pla\u017ei, restoranu \u2014 dok imate vlastitu prostrano parcelu.',
      inclusions: [
        'Besplatan Wi-Fi na parceli',
        'Pristup zajedni\u010dkim sanitarnim \u010dvorovima',
        'Priklju\u010dak za struju (16A)',
        'Priklju\u010dak za vodu na parceli',
        'Odvod otpadnih voda',
        'Pristup svim sadr\u017eajima kampa',
        'Pristup pla\u017ei',
        'Pristup bazenu',
        'Parkiranje',
      ],
    ...
    de: {
      ...
      description:
        'Superior Stellplatz \u00fcber 60 m\u00b2 im Medora Orbis Luxury Camp. Genie\u00dfen Sie alle Campingeinrichtungen \u2014 Pools, Strandzugang, Restaurant \u2014 mit Ihrem eigenen ger\u00e4umigen Stellplatz.',
      inclusions: [
        'Kostenloses WLAN auf dem Stellplatz',
        'Zugang zu gemeinsamen Sanit\u00e4ranlagen',
        'Stromanschluss (16A)',
        'Wasseranschluss auf dem Stellplatz',
        'Abwasserentsorgung',
        'Zugang zu allen Campingeinrichtungen',
        'Strandzugang',
        'Poolzugang',
        'Parkplatz',
      ],
...
export async function seedRooms({ payload }: { payload: Payload }) {
  ...
  const auriId = await getOrCreateProperty(payload, {
    ...
    type: 'hotel',
    shortDescription:
      'Beachfront 4-star resort on the Makarska Riviera with pools, spa and kids club.',
  ...
  await payload.updateGlobal({
    slug: 'auri-homepage',
    data: { featuredRooms: auriRoomIds.slice(0, 6) },
  })
  await payload.updateGlobal({
    slug: 'orbis-homepage',
    data: { featuredRooms: orbisRoomIds.slice(0, 6) },
  })
  ...
  const auriDoubleSeaViewId = await upsertGroup(
    'auri-double-sea-view',
    auriId,
    {
      en: 'Double rooms with sea view',
      hr: 'Dvokrevetne s pogledom na more',
      de: 'Doppelzimmer mit Meerblick',
    },
    { heroImage: auriFirstMediaIds[0]!, parent: auriDoubleGroupId, order: 1 },
  )
  const auriDoubleCreativeId = await upsertGroup(
    'auri-double-creative',
    auriId,
    {
      en: 'Double rooms for people with more imagination',
  ...
  const legacyOrbis = await payload.find({
    collection: 'room-groups',
    where: { slug: { equals: 'orbis-luxury-cabins' } },
    limit: 1,
    depth: 0,
  })
  ...
  const orbisSmallGroupId = await upsertGroup(
    ...
    orbisId,
    {
      en: 'Luxury Homes for 2\u20135 Persons',
      hr: 'Luksuzne ku\u0107ice za 2\u00a0-\u00a05 osoba',
      de: 'Luxush\u00e4user f\u00fcr 2\u20135 Personen',
    },
  ...
  const orbisLargeGroupId = await upsertGroup(
    ...
    orbisId,
    {
      en: 'Luxury Homes for 6\u20137 Persons',
      hr: 'Luksuzne ku\u0107ice za 6\u00a0-\u00a07 osoba',
      de: 'Luxush\u00e4user f\u00fcr 6\u20137 Personen',
    },
  ...
  const orbisPitchesGroupId = await upsertGroup(
    ...
    orbisId,
    {
      en: 'Pitches and Camp Sites',
      hr: 'Parcele i kamp mjesta',
      de: 'Stellpl\u00e4tze und Camping',
    },
  ...
  for (let i = 5; i <= 7; i++)
    await payload.update({
      collection: 'rooms',
      id: orbisRoomIds[i]!,
      data: { group: orbisLargeGroupId },
    })
  // Pitches: room [8]
  await payload.update({
    collection: 'rooms',
    id: orbisRoomIds[8]!,
    data: { group: orbisPitchesGroupId },
  })
